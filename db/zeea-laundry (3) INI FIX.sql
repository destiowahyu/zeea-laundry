...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Jun 2025 pada 16.42
-- Versi server: 10.4.32-MariaDB
-- Versi PHP: 8.2.12

-- Menonaktifkan mode ONLY_FULL_GROUP_BY untuk sesi ini agar kueri GROUP BY yang tidak ketat dapat diimpor.
-- Harap dicatat: Solusi jangka panjang adalah memperbaiki kueri GROUP BY di aplikasi PHP.
...
-- Fungsi
--
CREATE DEFINER=`root`@`localhost` FUNCTION `generate_tracking_code`() RETURNS VARCHAR(10) CHARSET utf8mb4 COLLATE utf8mb4_general_ci READS SQL DATA
BEGIN
...
--
-- Struktur dari tabel `antarjemput_status`
--
...
--
-- Dumping data untuk tabel `antarjemput_status`
--
...
INSERT INTO `antar_jemput` (`id`, `id_pesanan`, `nama_pelanggan`, `no_hp`, `id_pelanggan`, `layanan`, `alamat_antar`, `alamat_jemput`, `status`, `waktu_antar`, `waktu_jemput`, `harga_custom`, `deleted_at`) VALUES
(1, 38, 'Azzam Wisam Muafa Laniofa', '+6285955196688', 7, 'antar', 'Desa Padaran Dukuh Jambangan RT 05 RW 04', NULL, 'menunggu', '2025-04-28 13:00:00', NULL, NULL, NULL),
(2, 44, 'Azzam Wisam Muafa Laniofa', '+6285955196688', 7, 'antar', 'Ds Padaran', NULL, 'menunggu', '2025-05-02 15:00:00', NULL, NULL, NULL),
(3, 44, 'Azzam Wisam Muafa Laniofa', '+6285955196688', 7, 'antar', 'sfsf', NULL, 'menunggu', '2025-05-02 15:03:00', NULL, 0.00, NULL),
(4, 45, 'Gina Morissa Fenia', '+6285766655178', 15, 'antar', 'gina gina', NULL, 'selesai', '2025-05-02 15:47:00', NULL, NULL, NULL),
(5, NULL, NULL, NULL, NULL, 'jemput', NULL, 'Jalan Abadi No 12, Padaran', 'selesai', NULL, '2025-06-20 10:00:00', NULL, NULL),
(6, NULL, 'Sempurna', NULL, 22, 'jemput', NULL, 'Jalan Kedungmundu', 'selesai', NULL, '2025-06-25 00:39:00', NULL, NULL),
(7, NULL, 'Hindia Belanda', NULL, 23, 'jemput', NULL, 'Jalan KH. Mansyur No 10', 'menunggu', NULL, '2025-06-26 10:00:00', NULL, NULL);
...
(56, 'ZL250625023PQ2', 23, 14, 1.01, 6565.00, 'diproses', 'belum_dibayar', '2025-06-25 20:23:27', 0.00);
...
--
DELIMITER $$
CREATE TRIGGER `prevent_multiple_status_insert` BEFORE INSERT ON `toko_status` FOR EACH ROW
BEGIN
...
--
-- Indeks untuk tabel `antarjemput_status`
--
...
--
-- AUTO_INCREMENT untuk tabel `antarjemput_status`
--
ALTER TABLE `antarjemput_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
