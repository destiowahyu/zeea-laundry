...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jun 2025 pada 01.45
...
INSERT INTO `antar_jemput` (`id`, `id_pesanan`, `layanan`, `alamat_antar`, `alamat_jemput`, `status`, `waktu_antar`, `waktu_jemput`) VALUES
(1, 38, 'antar', 'Desa Padaran Dukuh Jambangan RT 05 RW 04', NULL, 'menunggu', '2025-04-28 13:00:00', NULL),
(2, 44, 'antar', 'Ds Padaran', NULL, 'menunggu', '2025-05-02 15:00:00', NULL),
(3, 44, 'antar', 'sfsf', NULL, 'menunggu', '2025-05-02 15:03:00', NULL),
(4, 45, 'antar', 'gina gina', NULL, 'menunggu', '2025-05-02 15:47:00', NULL);
...
(8, 'ZL2503210080b2', 8, 14, 2.50, 16250.00, 'diproses', 'sudah_dibayar', '2025-03-21 13:54:11', 0.00),
(9, 'ZL2503210080b2', 8, 14, 1.50, 9750.00, 'diproses', 'belum_dibayar', '2025-03-21 13:54:36', 0.00),
